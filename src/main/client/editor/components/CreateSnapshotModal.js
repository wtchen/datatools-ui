      ...
      <Modal show={this.state.showModal} onHide={this.close}>
        ...
        <Modal.Body>
          <FormGroup>
            ...
            <FormControl type='text' placeholder='Snapshot name (required)' ref='name' />
          </FormGroup>

          <FormGroup>
            <ControlLabel>Comment</ControlLabel>
            <FormControl componentClass='textarea' placeholder='Additional information (optional)' ref='comment' />
          </FormGroup>
        </Modal.Body>

        <Modal.Footer>
          <Button bsStyle='primary' onClick={() => this.ok()}>OK</Button>
