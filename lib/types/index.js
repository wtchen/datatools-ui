...
// A ParsedDate includes an index from the original dates array for update by the ExceptionDate component.
type ParsedDate = {
  date: string | 0,
  index: number
}
export type ParsedRangesAndDates = {
  dates: Array<ParsedDate>,
  ranges: Array<ScheduleExceptionDateRange>
}
