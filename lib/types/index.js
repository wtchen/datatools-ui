...
type ValidationErrorPriority = 'HIGH' | 'MEDIUM' | 'LOW' | 'UNKNWON'
...
export type ValidationError = {
  ...
  entity_type: string,
  error_type: string,
  error_type_priority: ValidationErrorPriority,
  line_number: number
}

export type ValidationResultErrorCounts = Array<{
  count: number,
...
export type ValidationResult = {
  ...
  errorCount: number,
  error_counts?: ValidationResultErrorCounts,
