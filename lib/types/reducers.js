...
export type TimetableContextMenuState = {
  /**
   * the context from which the menu was opened (either from a cell, a
   * row/column header, or the header edit button)
   */
  context?: ?string,
  display: boolean,
  left?: number,
...
export type TimetableState = {
  +activeCell: ?string,
  +contextMenu: TimetableContextMenuState,
  +edited: Array<number>,
...
export type GtfsPlusValidation = {
  [key: string]: Array<ValidationIssue>
}
