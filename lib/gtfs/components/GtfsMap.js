...
type Props = ContainerProps & {
  ...
  fetchFeedVersionIsochrones: typeof versionsActions.fetchFeedVersionIsochrones,
  mapState: MapFilter,
...
export default class GtfsMap extends Component<Props, State> {
  ...
  fetchIsochrones (latlng: LatLng) {
    ...
    this.props.fetchFeedVersionIsochrones(this.props.version, latlng.lat, latlng.lng, center.lat, center.lng)
  ...
  render () {
    ...
    return (
      <Map
        ...
        {
          (showStops || (this.props.entities && this.props.entities.indexOf('stops') !== -1)) &&
          stops &&
          stops.length &&
