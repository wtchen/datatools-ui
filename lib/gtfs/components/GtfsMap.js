...
import type {Bounds, Feed, FeedVersion, LatLng, GtfsRoute, GtfsStop} from '../../types'
import type {DateTimeFilter, MapState} from '../reducers/filter'
import type {StopWithFeed} from './StopMarker'
...
export default class GtfsMap extends Component<Props, State> {
  ...
  componentWillReceiveProps (nextProps: Props) {
    ...
    if (!disableRefresh) {
      if (nextProps.feeds.length !== feeds.length || nextProps.entities !== entities) {
