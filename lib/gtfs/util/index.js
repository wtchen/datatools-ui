...
import type {GtfsRoute, GtfsStop, Pattern, PatternLocation, PatternStop, User} from '../../types'
...
export function mergePatternHaltsOfPattern (pattern: Pattern) {
  return mergePatternHalts(pattern.patternStops, pattern.patternLocations)
}
