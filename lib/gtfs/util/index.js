...
import type {GtfsRoute, GtfsStop, Pattern, PatternHalt, PatternLocation, PatternStop, PatternStopArea, User} from '../../types'
...
export function getGraphQLFieldsForEntity (type: string, editor: boolean = false) {
  ...
  const patternStopAreaFields = `pattern_stop_areas (limit: -1) {
    id
    area_id
    stop_sequence
    pickup_type
...
export function mergePatternHalts (
  ...
  return [...patternLocations, ...patternStopAreas, ...patternStops]
    .sort((a, b) => a.stopSequence - b.stopSequence)
}
export function mergePatternHaltsOfPattern (pattern: Pattern) {
  return mergePatternHalts(pattern.patternStops, pattern.patternLocations, pattern.patternStopAreas)
}
