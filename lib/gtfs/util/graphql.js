...
query servicesQuery($namespace: String, $patternId: [String]) {
  feed(namespace: $namespace) {
...
query filteredStopsQuery($namespace: String, $patternId: [String], $serviceId: [String]) {
  feed(namespace: $namespace) {
    patterns(pattern_id: $patternId) {
      stops(limit: -1) {
        stop_id
      ...
      trips(service_id: $serviceId, limit: -1) {
        direction_id
        pattern_id
        service_id
        stop_times(limit: -1) {
