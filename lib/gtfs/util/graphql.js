...
export const routeSearch = (filterStopsByRoute?: string, limit?: number) => `routes (
  ${limit ? `limit: ${limit}` : ''},
...
// FIXME: turn stop_code back on
export const stopSearch = (filterRoutesByStop?: string, limit?: number) => `stops (
  ${limit ? `limit: ${limit}` : ''},
