...
import type {MapComponentProps, GridLayerProps} from 'react-leaflet'
...
class StopLayer extends GridLayer<MapComponentProps, ExtraProps> {
  static defaultProps = {
    minZoom: MIN_ZOOM
  }

  createLeafletElement (props: ExtraProps) {
    const gl = super.createLeafletElement(props)
    // $FlowFixMe: not sure what is happening here
