...
import type {Display, Route, Sign, Stop} from '../../types'
import type {dispatchFn, getStateFn, UserState} from '../../types/reducers'
...
export function createSign (
  ...
  return function (dispatch: dispatchFn, getState: getStateFn) {
    ...
    if (entity) {
      nextStopEntityId++
      // $FlowFixMe yes, stop_id may be undefined, that's why were checking it, flow!
...
export function saveDisplay (display: Display, user: UserState) {
  return function (dispatch: dispatchFn, getState: getStateFn) {
