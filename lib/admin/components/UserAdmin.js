...
import {
  ...
  setUserPage as setUserPageAction,
  setUserQueryString as setUserQueryStringAction
} from '../actions/admin'
import {
...
import {fetchProjects as fetchProjectsAction} from '../../manager/actions/projects'
...
type Props = {
  ...
  createOrganization: typeof createOrganizationAction,
  createUser: typeof createUserAction,
  deleteOrganization: typeof deleteOrganizationAction,
  ...
  fetchProjects: typeof fetchProjectsAction,
  ...
  updateOrganization: typeof updateOrganizationAction,
