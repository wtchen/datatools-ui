        ...
        <tr>
          ...
          <td>
            {permissions.isApplicationAdmin()
              ...
              : accountTypes.length > 1 && <BsLabel bsStyle={isUnknown ? 'warning' : isDefault ? 'default' : 'primary'}>{displayedAccountType}</BsLabel>
            }
          </td>
          <td>
          ...
          {/* When not editing, show the "Last login" cell and
              ...
              When editing, hide the "Last login" cell and
