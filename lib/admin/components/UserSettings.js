...
import type { AccountType, Organization, Project } from '../../types'
...
export default class UserSettings extends Component<Props, State> {
  ...
  constructor (props: Props) {
    ...
    this.state = {
      accountType: accountType || (defaultAccountType && defaultAccountType.type) || null,
  ...
  _handleAccountTypeChanged = (evt: SyntheticInputEvent<HTMLInputElement>) => {
        ...
        <Col xs={4}>
          <Panel>
            ...
            <Panel.Body>
              ...
              {!this.state.appAdminChecked && accountTypes.length > 1 && (
                <FormGroup controlId='formControlsAccountType'>
                  <ControlLabel>Account type</ControlLabel>
                  <FormControl
                    componentClass='select'
                    name='accountType'
                    onChange={this._handleAccountTypeChanged}
                    value={this.state.accountType}
                  >
                    {accountTypes.map(({ name, type }) => (
