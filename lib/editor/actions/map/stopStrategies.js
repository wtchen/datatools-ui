...
import type {dispatchFn, getStateFn, ControlPoint, GtfsStop, LatLng, Pattern} from '../../../types'
 ...
 */
export function addStopAtPoint (latlng: LatLng, addToPattern: boolean = false, index: number, activePattern: Pattern) {
 ...
 */
export function addStopAtIntersection (latlng: LatLng, activePattern: Pattern, controlPoints: Array<ControlPoint>) {
