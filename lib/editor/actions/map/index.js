...
import type {dispatchFn, getStateFn, Feed, LatLng, Pattern, ControlPoint} from '../../../types'

// Simple actions
export const updatePatternGeometry = createAction('UPDATE_PATTERN_GEOMETRY')
const updateTempPatternGeometry = createAction('UPDATE_TEMP_PATTERN_GEOMETRY')
...
export function constructControlPoint (
  {pattern, latlng, controlPoints, segmentIndex, segmentCoordinates, patternCoordinates}:
  {
    pattern: Pattern,
    latlng: LatLng,
  ...
  return function (dispatch: dispatchFn, getState: getStateFn) {
    const patternLine = lineString(shapePointsToSimpleCoordinates(pattern.shapePoints))
    ...
    const {beforeSlice: beforeSegment, afterSlice: afterSegment} = getLineSlices(segmentLine, pointOnLine)
...
export function handleControlPointDragEnd (controlPoints: Array<ControlPoint>, index: number, latlng: LatLng, pattern: Pattern, patternCoordinates: any) {
  return function (dispatch: dispatchFn, getState: getStateFn) {
