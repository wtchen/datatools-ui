...
export const closeTimetableContextMenu = createVoidPayloadAction('CLOSE_TIMETABLE_CONTEXT_MENU')
...
export const showTimetableContextMenu = createAction(
  'SHOW_TIMETABLE_CONTEXT_MENU',
  (payload: { context: string, left: number, top: number }) => payload
)
...
/**
 * Stop time recalculations
 */

/**
 * Recalculates all stop times using pattern defaults on the trip of the cell
 * that the context menu is associated with.
 */
export function calculateAllStopsOnCellTrip() {
  return function (dispatch: dispatchFn, getState: getStateFn) {
...
/**
 * Recalculates all stop times using pattern defaults on the selected trips.
 */
export function calculateAllStopsOnSelectedTrips() {
  return function (dispatch: dispatchFn, getState: getStateFn) {
...
/**
 * Recalculates just the stop times of the trip that the context menu is
 * associated with using pattern defaults.
 */
export function calculateSingleStopTime() {
  return function (dispatch: dispatchFn, getState: getStateFn) {
...
/**
 * Recalculates the stop times using pattern defaults on the selected trips,
 * but only on the stop that the context menu is associated with.
 */
export function calculateStopOnSelectedTrips() {
  return function (dispatch: dispatchFn, getState: getStateFn) {
...
/**
 * Recalculates stop times that are missing (interpolated) using pattern
 * defaults on the trip that the context menu is associated with.
 */
export function calculateStopsWithoutTimesOnCellTrip() {
  return function (dispatch: dispatchFn, getState: getStateFn) {
...
/**
 * Recalculates stop times that are missing (interpolated) using pattern
 * defaults on the selected trips.
 */
export function calculateStopsWithoutTimesOnSelectedTrips() {
  return function (dispatch: dispatchFn, getState: getStateFn) {
