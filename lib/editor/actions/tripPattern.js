...
import type {ControlPoint, Pattern, PatternLocationGroup, PatternLocation, PatternStop} from '../../types'
...
export function updatePatternStops (
  ...
  return function (dispatch: dispatchFn, getState: getStateFn) {
    ...
    const {stops, locations, locationGroups} = sortedPatternHalts.reduce(
      (acc, cur) => {
