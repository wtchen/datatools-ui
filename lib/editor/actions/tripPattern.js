...
export function updatePatternStops (
  ...
  return function (dispatch: dispatchFn, getState: getStateFn) {
    ...
    const { stops, stopAreas, locations } = sortedPatternHalts.reduce(
      (acc, cur) => {
      ...
      updateActiveGtfsEntity(
        {
          ...
          entity: pattern,
          props: { patternStops: stops, patternLocations: locations, patternStopAreas: stopAreas }
        }
      )
    )
  }
