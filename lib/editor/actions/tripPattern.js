 ...
 *
 * FIXME: this needs additional work, including displaying the result to the user.
 */
  ...
  return function (dispatch: dispatchFn, getState: getStateFn) {
    ...
    return dispatch(secureFetch(url, method, patternData))
      ...
      .then(newTripPattern => {
        ...
        // TODO: Determine if # of pattern stops, order of pattern stops, or
        // default travel/dwell time changed and show warning button to tell user
        // to normalize stop times.
