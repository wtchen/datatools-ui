...
const mapStateToProps = (state: AppState, ownProps: GtfsEditor & {location: any, routeParams: any}) => {
  const {
    feedSourceId,
    activeComponent,
    subComponent,
...
const mapDispatchToProps = (dispatch: dispatchFn, ownProps: GtfsEditor & {location: any, routeParams: any}): any => {
  const {
    feedSourceId,
    activeComponent,
    subComponent,
