...
const mapDispatchToProps = (dispatch: dispatchFn, ownProps: GtfsEditor & {routeParams: any, location: any}): any => {
  const {
    feedSourceId,
    activeComponent,
    subComponent,
  ...
  return {
    ...
    updateActiveEntity: (entity, component, props) => dispatch(updateActiveGtfsEntity({component, entity, props})),
