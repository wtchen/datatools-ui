...
import {getActivePatternLocations, getActivePatternStopAreas, getActivePatternStops, getControlPoints, getValidationErrors} from '../selectors'
...
const mapStateToProps = (state: AppState, ownProps: Props) => {
  ...
  const activePatternStopAreas = getActivePatternStopAreas(state)
  return {
    activeComponent,
    activeEntity,
    activeEntityId,
