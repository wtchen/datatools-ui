...
import MessageComponent from '../../common/components/MessageComponent.js'
...
import type {Feed, FeedInfo, Project, Snapshot} from '../../types'

type Props = {
  createSnapshot: (Feed, string, ?string) => void,
  displayRoutesShapefile: (Feed, File) => void,
  feedInfo: FeedInfo,
  feedSource: Feed,
 ...
 * Editor.
 */
export default class FeedInfoPanel extends MessageComponent<Props, State> {
  state = {
    right: 5
  }
  ...
  _onOkClicked = (name: string, comment: ?string) => {
