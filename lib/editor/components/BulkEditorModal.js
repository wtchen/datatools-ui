...
import type { Entity, Feed, Field } from '../../types'
...
export default class BulkEditorModal extends Component<Props, State> {
  ...
  render () {
    ...
    const { activeComponent, feedSource, tableData } = this.props
...
class PatchField extends Component<PatchFieldProps> {
  ...
  render () {
    const { activeComponent, approveGtfsDisabled, field, patch, tableData } = this.props
