...
export default class TimetableEditor extends Component {
  ...
  constructNewRow = (toClone = null) => {
    ...
    for (let i = 0; i < activePattern.patternStops.length; i++) {
      ...
      objectPath.set(newRow, `stopTimes.${i}.stopSequence`, stop.stop_sequence)
      // }
    }
    ...
    objectPath.set(newRow, 'routeId', activePattern.route_id)
    // FIXME: fix direction ID
    objectPath.set(newRow, 'directionId', activePattern.direction_id || 0)
