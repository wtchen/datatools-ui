...
import type {Feed, FetchStatus, GtfsRoute, Pattern, TimetableColumn, Trip} from '../../../types'
...
type Props = {
  ...
  setScrollIndexes: {scrollToRow: number, scrollToColumn: number} => void,
...
export default class TimetableEditor extends Component<Props, State> {
  ...
  _createNewCalendar = () => this.props.setActiveEntity(this.props.feedSource.id, 'calendar', {id: ENTITY.NEW_ID})
  ...
  constructNewRow = (toClone?: any = null) => {
