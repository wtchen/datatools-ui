...
export default class Timetable extends Component {
  ...
  state = {
    activeCell: '' // 'rowNum-colNum', e.g. 0-1
  }

  updateScroll = (scrollToRow: number, scrollToColumn: number) => this.keyStepper.setScrollIndexes({scrollToRow, scrollToColumn})

  setActiveCell = (activeCell: string) => this.setState({activeCell})

  cellValueInvalid = (col: Object, value: number, previousValue: number) => isTimeFormat(col.type) && value >= 0 && value < previousValue
