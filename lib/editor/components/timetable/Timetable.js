...
export default class Timetable extends Component {
  ...
  updateScroll = (scrollToRow, scrollToColumn) => {
    this.keyStepper.setScrollIndexes({scrollToRow, scrollToColumn})
  ...
  render () {
    ...
    return (
      <ScrollSync>
        {(syncProps) => {
          // NOTE: syncProps include the following:
          ...
          return (
            <div>
              <ArrowKeyStepper
                ...
                mode={'cells'}
                onScrollToChange={e => { console.log(e) }}
                onSectionRendered={e => { console.log(e) }}
