...
import type {ControlPoint, Coordinates, Feed, GtfsLocation, GtfsStop, GtfsStopArea, Pattern} from '../../../types'
          ...
          {addStops
            ? <div className='pattern-stop-card'>
              <VirtualizedEntitySelect
                ...
                entities={[
                  ...stops,
                  ...locations.map(l => { return {...l, id: uuidv4()} }),
                  ...stopAreas.map(area => { return {...area, id: uuidv4()} })
                ]}
