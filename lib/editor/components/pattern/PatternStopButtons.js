...
export default class PatternStopButtons extends Component {
  ...
  _onClickRemove = () => {
    const {activePattern, controlPoints, patternSegments, index, removeStopFromPattern, stop} = this.props
    removeStopFromPattern(activePattern, stop, index, controlPoints, patternSegments)
  }
