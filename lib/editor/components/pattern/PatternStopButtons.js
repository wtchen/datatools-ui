...
import type {Feed, GtfsLocation, GtfsStop, Pattern, PatternLocation, PatternStop, Style} from '../../../types'
...
export default class PatternStopButtons extends Component<Props> {
  ...
  render () {
    ...
    const haltType = stop.hasOwnProperty('location_id') ? 'location' : 'stop'
    return (
      <ButtonGroup
