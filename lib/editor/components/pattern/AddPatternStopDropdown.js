...
import type {GtfsLocation, GtfsStop, Pattern, PatternLocation, PatternLocationGroup, PatternStop, Style} from '../../../types'
...
type Props = {
  ...
  label?: string,
  patternStop?: PatternStop | PatternLocation | PatternLocationGroup, // optional current pattern stop
  size?: string,
