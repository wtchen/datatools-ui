...
import type {GtfsLocation, GtfsStop, Feed, Pattern, PatternLocation, PatternLocationGroup, PatternStop} from '../../../types'
...
type State = {
  cards: Array<PatternStop | PatternLocation | PatternLocationGroup>
}
    ...
    return connectDropTarget(
      <div>
        {cards.map((card, i) => {
          ...
          if (card.hasOwnProperty('locationId') && !card.hasOwnProperty('locationGroupId')) {
            // $FlowFixMe flow doesn't appreciate our type check
          ...
          if (card.hasOwnProperty('locationGroupId')) {
            // $FlowFixMe flow doesn't appreciate our type check
