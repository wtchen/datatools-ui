...
class PatternStopContainer extends Component<Props, State> {
  componentWillMount () {
    ...
    this.setState({
      cards: [...patternLocations, ...patternStops].sort((a, b) => a.stopSequence - b.stopSequence)
    })
  }
  ...
  componentWillReceiveProps (nextProps) {
    ...
    const {patternLocations, patternStops} = this.props.activePattern
    if (
      (nextProps.activePattern.patternStops &&
        !shallowEqual(nextProps.activePattern.patternStops, patternStops)
      ) ||
      (nextProps.activePattern.patternLocations &&
        !shallowEqual(nextProps.activePattern.patternLocations, patternLocations))
    ) {
      this.setState({
        cards: [...patternLocations, ...patternStops].sort((a, b) => a.stopSequence - b.stopSequence)
      })
