...
const PickupDropoffSelect = (props: Props) => {
  const {activePattern, controlLabel, selectType, shouldHaveDisabledOption, title, _onPickupOrDropOffChange, selectValue} = props
  ...
  return (
    <FormGroup
      ...
      <FormControl
        ...
        onChange={_onPickupOrDropOffChange}
        value={selectValue}
        placeholder='select'>
