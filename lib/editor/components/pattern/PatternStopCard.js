...
class PatternStopContents extends Component<Props, State> {
  ...
  _renderPickupDropOffTypes = (defaultPickupDropOff: number) => {
  ...
  render () {
    ...
    const stopRows = (
      <div>
        ...
        {feedSource.flexUIFeaturesEnabled && this._renderPickupDropOffTypes(0)}
    ...
    const locationRows = feedSource.flexUIFeaturesEnabled && (
      <div>
        ...
        {this._renderPickupDropOffTypes(2)}
        <Row>
          <Col xs={6}>
