...
class PatternStopCard extends Component {
  ...
  handleClick = () => {
    const {active, id, setActiveStop} = this.props
      ...
      <div style={{ ...style, opacity }}>
        ...
        <div
          ...
          <div className='pull-left'>
            <p style={{margin: '0px'}} title={titleStopName}><Icon type={active ? 'caret-down' : 'caret-right'} />{fullStopName.length > 25 ? fullStopName.substr(0, 25) + '...' : fullStopName}</p>
          </div>
            ...
            <Row>
              ...
              <Col xs={6}>
                <Button
                  ...
                  onClick={this._onClickRemovePatternStop}>
