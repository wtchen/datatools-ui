...
import type {ControlPoint, Feed, GtfsStop, Pattern, PatternStop, PatternStopArea} from '../../../types'
import { mergePatternHaltsOfPattern } from '../../../gtfs/util'
import { patternHaltIsStop, patternHaltIsStopArea } from '../../util/location'
...
type Props = {
  ...
  patternStop: PatternStop | PatternStopArea,
...
export default class PatternStopMarker extends Component<Props> {
  ...
  render () {
    ...
    if (!!patternStop && !patternHaltIsStop(patternStop) && !patternHaltIsStopArea(patternStop)) {
      return null
    }
