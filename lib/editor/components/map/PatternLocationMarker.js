...
export default class PatternLocationMarker extends Component<Props> {
  ...
  _onChangeTravelTime = (value: number) => {
    ...
    if (patternStops[index].defaultDwellTime) return
  ...
  render () {
    const {active, index, location, patternStop: patternLocation} = this.props
                  ...
                  <Row>
                    <Col xs={6}>
                      <FormGroup
                        ...
                        <MinuteSecondInput
                          seconds={patternLocation.defaultTravelTime}
                    ...
                    <Col xs={6}>
                      <FormGroup
                        ...
                        <MinuteSecondInput
                          seconds={patternLocation.defaultDwellTime}
