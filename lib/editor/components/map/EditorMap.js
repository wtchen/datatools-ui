    ...
    if (subComponent === 'trippattern' && editSettings.editGeometry) {
      switch (editSettings.onMapClick) {
        ...
        case 'ADD_STOPS_AT_INTERVAL':
          return addStopAtInterval(e.latlng, activePattern)
        default:
          break
      }
    }
        ...
        return (
          <FeatureGroup>
            ...
            <PatternsLayer
              ...
              patternSegment={this.props.patternSegment}
              temporaryPatternCoordinates={this.props.temporaryPatternCoordinates}
  ...
  render () {
    ...
    return (
      <Map {...mapProps}>
        ...
        {!hidden &&
          this._getMapComponents(activeComponent, activeEntity, subEntityId, activePattern, stops, editSettings, mapState)
        }
