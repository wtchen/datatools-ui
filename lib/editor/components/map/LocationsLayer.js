...
import { EditControl } from '@andrewdodd/react-leaflet-draw'
    ...
    Object.values(layers)
      .filter(
        (layer) =>
          ...
          !!layer._latlngs &&
          typeof layer._latlngs === 'object' &&
          layer._latlngs.length &&
          typeof layer._latlngs.length === 'number' &&
      ...
      .forEach((layer) => {
        ...
        const onDeletedKeys: Array<string> = Object.keys(
          ...
          (key === leafletId) || (this.checkSameShape(groupedLocationShapePts[key], layerCoords))
        )
