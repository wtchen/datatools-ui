...
import type {EditorTableData, Entity, GtfsFare, GtfsRoute, ZoneOption, Zones, FareRule} from '../../types'
import type {EntityOption} from './VirtualizedEntitySelect'

type EditableRuleFields = $Keys<$Diff<FareRule, {id: number, fare_id: string}>>
