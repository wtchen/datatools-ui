...
import type {EditorTableData, Entity, FareRule, GtfsFare, ZoneOption, Zones} from '../../types'
...
class FareRuleItem extends Component<RuleProps, State> {
  state = ruleToState(this.props.rule)
  ...
  _onChangeCheckbox = (newValue: boolean, type: RuleType) => {
    ...
    if (newValue === false) updateActiveEntity(activeEntity, activeComponent, {fare_rules: rules})
  }
