...
export default class EditorInput extends Component<Props> {
  ...
  render () {
    ...
    switch (field.inputType) {
      ...
      case 'CURRENCY':
        // Ensure currencies are sorted (sorts in place).
        ...
        return (
          <FormGroup
            ...
            <FormControl
              ...
              {/*
                Add field for empty string value if that is not an allowable
                option so that user selection triggers onChange
              */}
              <option
                disabled
                value=''>
