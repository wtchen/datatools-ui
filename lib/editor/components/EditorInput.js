...
import type {GtfsAgency, GtfsLocation, GtfsStop, GtfsSpecField, Feed, Entity} from '../../types'
...
import StopAreasEditor from './StopAreasEditor'
...
export default class EditorInput extends React.Component<Props> {
  ...
  render () {
    ...
    console.log('activeEntity changed', activeEntity)
