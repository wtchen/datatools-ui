...
export default class GtfsEditor extends Component<Props, State> {
  componentWillMount () {
    ...
    this.props.lockEditorFeedSourceIfNeeded(this.props.feedSourceId, editorActions.GTFS_EDITOR_LOCK)
    this._refreshEditor()
  }
  ...
  componentWillReceiveProps (nextProps: Props) {
    ...
    if (nextProps.feedSourceId !== feedSourceId) {
      ...
      // lockEditorFeedSourceIfNeeded(nextProps.feedSourceId, editorActions.GTFS_EDITOR_LOCK)
