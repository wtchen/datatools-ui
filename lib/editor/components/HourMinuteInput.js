...
export default class HourMinuteInput extends Component<Props, State> {
  ...
  render () {
    ...
    const roundLeftBorder = '4px 0px 0px 4px'
    const roundRightBorder = '0px 4px 4px 0px'
    return (
      <span style={{display: 'flex', alignItems: 'baseline'}}>
        ...
        <FormControl
          ...
          style={{
            ...
            marginLeft: -5,
            borderLeft: 'none',
            borderRadius: standaloneInput ? roundRightBorder : 0,
            ...style
          }}
