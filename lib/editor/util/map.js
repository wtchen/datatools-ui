...
export const stopIsOutOfBounds = (stop: GtfsStop | GtfsLocation, bounds: any) => {
  if (stop.location_id) {
    ...
    locationShapes.find(locationShapePt =>
      locationShapePt.geometry_pt_lat > bounds.getNorth() ||
      locationShapePt.geometry_pt_lat < bounds.getSouth() ||
      locationShapePt.geometry_pt_lon > bounds.getEast() ||
      locationShapePt.geometry_pt_lon < bounds.getWest()
    )
