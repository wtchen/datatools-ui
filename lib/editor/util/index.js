...
// FIXME: Generalise function to Location Groups and Zones
// eslint-disable-next-line complexity
// TODO: Fix this once we're ready for location groups
// export function getLocationGroups (
//   stops: ?Array<GtfsStop>,
//   locations: ?Array<GtfsLocation>,
//   activeEntity: ?(GtfsStop | GtfsLocation)
// ): {[string]: LocationGroup} {
//   const locationGroups = {}
//   if (stops) {
//     for (var i = 0; i < stops.length; i++) {
//       const stop = stops[i]
//       const {location_group_id: locationGroupId} = stop
//       if (locationGroupId) {
//         let locationGroup = locationGroups[locationGroupId]
//         if (!locationGroup) locationGroup = []
//         locationGroup.push(stop)
//         locationGroups[locationGroupId] = locationGroup
//       }
//     }
//   }
...
//         const { location_group_id: locationGroupId } = location
//         if (locationGroupId) {
//           let locationGroup = locationGroups[locationGroupId]
//           if (!locationGroup) {
//             locationGroup = []
...
//   if (activeEntity && activeEntity.location_group_id && !locationGroups[activeEntity.location_group_id]) {
//     const {location_group_id: locationGroupId} = activeEntity
//     locationGroups[locationGroupId] = [activeEntity]
//   }

//   const locationGroupOptions = Object.keys(locationGroups).map(key => {
//     return {
//       value: key,
//       label: `${key} location group (${locationGroups[key] ? locationGroups[key].length : 0} stops or locations)`
//     }
//   })
//   return {locationGroups, locationGroupOptions}
// }
