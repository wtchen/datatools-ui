...
export function getControlPoints (pattern, snapToStops) {
  ...
  const controlPoints = []
  if (pattern.shape && pattern.patternStops) {
    pattern.patternStops.map((patternStop, index) => {
