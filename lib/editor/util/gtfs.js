...
export function getEntityName (entity: any): string {
  ...
  console.log('heres entity', entity)
  ...
  if (typeof entity.route_id !== 'undefined') {
    ...
    nameKey = 'agency_name'
    // Stop Areas have a stop id, but shouldn't be named as a location group
  } else if (typeof entity.stop_id !== 'undefined' && typeof entity.area_id === 'undefined') {
    nameKey = 'stop_name'
  } else if (typeof entity.location_id !== 'undefined') {
  ...
  switch (nameKey) {
    ...
    case 'stop_area_name':
      const stopArea: GtfsStopArea = ((entity: any): GtfsStopArea)
      // TODO: logic looking up area name from table?
      return stopArea.area_id || NO_NAME
