    ...
    const ACCOUNT_SECTIONS = [
      {
        ...
        component: (
          <div>
            <Panel >
              <Panel.Heading>Profile Information</Panel.Heading>
              <ListGroup fill>
                <ListGroupItem>
      ...
      <ManagerPage ref='page'>
        <Grid fluid>
          ...
          <Row>
            <Col xs={3}>
              <Panel >
                <Panel.Heading>{this.messages('personalSettings')}</Panel.Heading>
                <ListGroup fill>
              ...
              <Panel >
                <Panel.Heading>{this.messages('organizationSettings')}</Panel.Heading>
                <ListGroup fill>
