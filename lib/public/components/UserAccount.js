...
import {getAccountInfo, getSettingsFromProfile} from '../../common/util/user'
...
export default class UserAccount extends Component<Props> {
  ...
  render () {
    ...
    const { accountType, accountTypeObject, displayName, isUnknown } = getAccountInfo(profile, accountTypes)
