...
import {getAccountDisplayName, getSettingsFromProfile} from '../../common/util/user'
...
export default class UserAccount extends Component<Props> {
  ...
  render () {
    ...
    const { accountType, accountTypeObject, displayName, isUnknown } = getAccountDisplayName(profile, accountTypes)
          ...
          <div>
            <Panel>
              ...
              <ListGroup>
                ...
                {((accountTypes.length > 1 && displayedAccountType) || isUnknown) && (
                  <ListGroupItem>
