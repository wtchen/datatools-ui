...
import type {Props as ContainerProps} from '../containers/ActivePublicFeedsViewer'
import type {Coordinate, Feed, Project} from '../../types'

type Props = ContainerProps & {
  fetchProjectsWithPublicFeeds: typeof projectsActions.fetchProjectsWithPublicFeeds,
...
export default class PublicFeedsViewer extends Component<Props, State> {
  ...
  componentWillMount () {
    this.props.fetchProjectsWithPublicFeeds()
  }
