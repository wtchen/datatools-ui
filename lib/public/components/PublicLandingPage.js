...
const DEFAULT_TITLE = 'Data Tools'
const DEFAULT_DESCRIPTION = 'A command center for managing, editing, validating, and deploying GTFS feeds.'
const DEFAULT_LOGO = 'https://d2f1n6ed3ipuic.cloudfront.net/conveyal-512x512.png'
