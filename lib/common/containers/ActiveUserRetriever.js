...
import { getAccountTypes, getUserInfoForThisClient } from '../util/user'
 ...
 */
function showLicenseIfNeeded (accountTypes: Array<AccountType>, profile: User) {
