...
export default class App extends Component<Props> {
  checkLogin = (nextState: any, replace: any, callback: (?any) => void) => {
  ...
  requireAdmin = (nextState: any, replace: any, callback: (?any) => void) => {
  ...
  requireAuth = (nextState: any, replace: any, callback: (?any) => void) => {
    const {dispatch, getState} = this.props.store
