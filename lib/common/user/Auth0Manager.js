...
export const auth0Client = new auth0.WebAuth({ domain, clientID })
export const DEFAULT_SCOPE = 'app_metadata profile email openid user_metadata'
    ...
    return this._getProfileFromToken(accessToken)
      .then(profile => {
        ...
        if (push && redirectOnSuccess) {
          // TODO: react router upgrade broke the react router push here, this is a hack
