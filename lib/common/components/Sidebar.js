...
import type {JobStatusState, ManagerUserState, ServerInfo} from '../../types/reducers'
...
export default class Sidebar extends MessageComponent<Props, State> {
  state = {
    visiblePopover: null
  }
            ...
            <div className='app-info'>
              ...
              <table>
                ...
                <tr>
                  ...
                  <td>
                    {serverInfo && serverInfo.repoUrl !== '?'
                      ? (
                        <a href={`${serverInfo.repoUrl}/commit/${serverInfo.commit}`}>
                          {serverInfo.commit.slice(0, 6)}
                        </a>
                      )
                      : this.messages('unknown')
                    }
...
class Brand extends MessageComponent<{expanded: boolean}> {
  render () {
