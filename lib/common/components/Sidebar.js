...
import type {JobStatusState} from '../../manager/reducers/status'
...
type Props = {
  ...
  userPicture: string,
  logout: () => void,
  removeRetiredJob: ServerJob => void,
  revokeToken: () => void,
...
export default class Sidebar extends React.Component<Props, State> {
  ...
  _selectHelp = () => this._select(POPOVER.HELP)
  _selectJob = () => this._select(POPOVER.JOB)
  _selectUser = () => this._select(POPOVER.USER)
