...
import {clearStatusModal as clearStatusModalAction} from '../../manager/actions/status'
import {removeEditorLock as removeEditorLockAction} from '../../editor/actions/editor'

type Props = {
  action?: string,
  body?: string,
  clearStatusModal: typeof clearStatusModalAction,
  detail?: string,
  removeEditorLock: typeof removeEditorLockAction,
  title?: string
}
