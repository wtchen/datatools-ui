...
import type {FeedVersion, Project} from '../../types'

export function defaultSorter (a: FeedVersion | Project, b: FeedVersion | Project): number {
...
export function getAbbreviatedProjectName (project: Project): string {
  return project && project.name.length > 16
...
export function versionsSorter (a: FeedVersion, b: FeedVersion): number {
