...
/**
 * Gets the friendly text to display for the account type of the given user.
 */
export function getAccountDisplayName (user: UserProfile, accountTypes: Array<AccountType>): {
  accountType: ?string,
