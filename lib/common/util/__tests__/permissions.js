...
import {deploymentsEnabledAndAcessAllowedForProject} from '../permissions'

import mockData from '../../../../__tests__/test-utils/mock-data'

const {mockAdminUser, mockProjectWithDeployments} = mockData.manager

describe('lib > common > util > permissions', () => {
  describe('> deploymentsEnabledAndAcessAllowedForProject', () => {
    const testCases = [
      {
        ...
        expectedResult: true,
        project: mockProjectWithDeployments,
        user: mockAdminUser
      }
    ]
    ...
    testCases.forEach(testCase => {
      it(`should return ${
        ...
        expect(deploymentsEnabledAndAcessAllowedForProject(
          testCase.project,
          testCase.user
