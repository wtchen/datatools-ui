...
export default class GtfsPlusEditor extends Component {
  static propTypes = {
    ...
    gtfsEntityLookup: PropTypes.func,
  ...
  _newRowsDisplayed = (rows) => {
    this.props.newRowsDisplayed(this.props.activeTable.id, this.props.rows, this.props.feedSource)
  }

  _selectTable = (activeTableId) => {
    this.setState({activeTableId})
  }
