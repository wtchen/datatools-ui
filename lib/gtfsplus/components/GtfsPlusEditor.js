...
export default class GtfsPlusEditor extends Component<Props> {
  ...
  componentCleanUp = () => {
    ...
    stopLockTimer()
    removeEditorLockLastGasp(feedSourceId, editorActions.GTFS_PLUS_EDITOR_LOCK)
  }
  ...
  onFocus = () => {
    ...
    checkLockStatus(feedSourceId, editorActions.GTFS_PLUS_EDITOR_LOCK)
  }
  ...
  onVisibilityChange = () => {
    ...
    if (document.visibilityState === 'visible') {
      ...
      if (!errorStatus.modal) {
        lockEditorFeedSource(feedSourceId, editorActions.GTFS_PLUS_EDITOR_LOCK)
      }
    } else {
