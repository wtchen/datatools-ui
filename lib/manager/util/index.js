...
/**
 * Converts an array of Label objects and string IDs into array of strings, the IDs of
 * those labels
 * @param {Array<Label | string>} labels An array of strings and Label objects
 * @returns                              An array of label IDs
 */
export function stringifyLabels (labels: Array<any>): Array<any> {
  if (!labels) return []
