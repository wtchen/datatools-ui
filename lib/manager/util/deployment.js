...
export const EC2_INFO_FIELDS: Array<FormProps> = [
  {
    ...
    name: 'otpServers.$index.ec2Info.iamRoleArn',
    placeholder: 'arn:aws:iam::$ACCOUNT_NUMBER:instance-profile/$ROLE_NAME',
    required: true,
    type: 'text',
    width: 12
  }, {
...
export function getActiveInstanceCount (instances: Array<EC2InstanceSummary>) {
  return instances.filter(instance => instance.state.name === 'running').length
}
