      ...
      <Panel
        header={
          <Row>
            <Col xs={4}>
              <FormControl
                placeholder={getMessage(this.messages, 'search')}
            ...
            <Col xs={8}>
              <Button
                ...
                <Glyphicon glyph='plus' /> {getMessage(this.messages, 'new')}
              </Button>
            </Col>
          </Row>
        }>
        <Table striped hover fill>
          <thead>
            <tr>
              <th className='col-md-4'>{getMessage(this.messages, 'table.name')}</th>
              <th>{getMessage(this.messages, 'table.creationDate')}</th>
              <th>{getMessage(this.messages, 'table.lastDeployed')}</th>
              <th>{getMessage(this.messages, 'table.deployedTo')}</th>
              <th>{getMessage(this.messages, 'table.feedCount')}</th>
              <th>{getMessage(this.messages, 'table.testDeployment')}</th>
              <th />
            </tr>
          </thead>
          <tbody>
