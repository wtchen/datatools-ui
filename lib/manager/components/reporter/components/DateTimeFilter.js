...
export default class DateTimeFilter extends Component {
  ...
  render () {
    ...
    const validDate = this.props.version && moment(dateTime.date).isBetween(this.props.version.validationSummary.startDate, this.props.version.validationSummary.endDate)
    console.log(validDate, this.props, moment(dateTime.date).isBetween(this.props.version.validationSummary.startDate, this.props.version.validationSummary.endDate))
    return (
      <div>
        <Row>
