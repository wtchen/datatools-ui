...
import type {Deployment, ReactSelectOption} from '../../types'
...
export default class DeploymentViewer extends Component<Props, State> {
  ...
  render () {
    ...
    const serverDeployedTo = deployment.deployedTo
      ? project.otpServers.find(server => server.id === deployment.deployedTo)
      : null
                          ...
                          ? project.otpServers.map((server, i) => (
                            <MenuItem
                              ...
                              disabled={
                                ...
                                (server.targetGroupArn && deployment.feedSourceId)
                              }
                              eventKey={server.id}
                              key={server.id}
                            >
