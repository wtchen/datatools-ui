...
type Props = {
  ...
  project: Project,
  refreshDeploymentData: typeof deploymentActions.refreshDeploymentData,
...
export default class DeploymentViewer extends Component<Props, State> {
  ...
  componentWillMount () {
    const {deployment, refreshDeploymentData, user} = this.props
    refreshDeploymentData(deployment, user.profile)
  }
