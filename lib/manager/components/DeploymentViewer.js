...
export default class DeploymentViewer extends MessageComponent<Props, State> {
  ...
  _onUpdateVersion = (option) => this._updateDeployment({
    [`${this.props.deployment.r5 ? 'r5' : 'otp'}Version`]: option.value
  })

  _updateDeployment= (props) => this.props.updateDeployment(this.props.deployment, props)
