...
export default class DeploymentViewer extends Component<Props, State> {
  ...
  _onChangeSkipOsmExtract = () => this._updateDeployment({skipOsmExtract: !this.props.deployment.skipOsmExtract})
  ...
  _setOsmUrl = () => {
    const osmExtractUrl = window.prompt('Please provide a public URL from which to download an OSM extract (.pbf).')
    if (osmExtractUrl) {
              ...
              <ListGroup fill>
                ...
                <ListGroupItem>
                  ...
                  {deployment.osmExtractUrl
                    ? <div>
                      <small>{deployment.osmExtractUrl}</small>
                      <Button
                        bsSize='xsmall'
                        style={{marginLeft: '5px'}}
                    ...
                    : <div>
                      <small>Auto-extract OSM (N. America only)</small>
                      <Button
                        bsSize='xsmall'
                        style={{marginLeft: '5px'}}
                  ...
                  <Checkbox
                    ...
                    onChange={this._onChangeSkipOsmExtract}>Include OSM</Checkbox>
                </ListGroupItem>
                <ListGroupItem>
                  <CustomConfig
