...
import type {FeedVersion, Note} from '../../../types'
...
export default class FeedVersionNavigator extends Component<Props, State> {
  ...
  _onFetchValidation = (version: FeedVersion) => {
  ...
  _onRequestGtfsPlusData = (version: FeedVersion) => {
    this.props.downloadGtfsPlusFeed(version.id)
  }
