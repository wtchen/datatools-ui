...
export default class FeedVersionViewer extends MessageComponent<Props> {
  render () {
    const {
      feedVersionIndex,
      listView,
...
class VersionSectionSelector extends MessageComponent<SelectorProps> {
...
class VersionList extends MessageComponent<ListProps> {
  render () {
...
export class VersionButtonToolbar extends MessageComponent<ToolbarProps> {
  _onClickDownload = () =>
