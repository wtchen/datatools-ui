...
const iconForRetrievalMethod = (retrievalMethod: RetrievalMethod) => {
...
export default class VersionRetrievalBadge extends React.Component<Props> {
  render () {
    ...
    return (
      <Icon
        title={toSentenceCase(version.retrievalMethod.replace(/_/g, ' '))}
        type={iconForRetrievalMethod(version.retrievalMethod)}
      />
    )
  }
}
