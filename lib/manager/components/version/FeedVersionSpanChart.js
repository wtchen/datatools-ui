    ...
    return (
      <div style={{ ...style, display: 'flex' }}>
        ...
        <div style={{ minHeight: HEIGHT_PROP, position: 'relative', width: '400px' }}>
          {/* Components below are all rendered as direct children of this div to accommodate
              drawing the "today" line marker above the FeedSpan, while keeping it
              under the FeedStartLabel and FeedEndLabel contents.
              FIXME[React 16+]: Extract FeedStartLabel, FeedEndLabel, FeedSpan into <>...</> markup.
            */}
          ...
          {comparedVersionProp && hasGap &&
            ...
            />}
          {comparedVersionProp && <FeedStartLabel {...comparedChartProps} />}
          {comparedVersionProp && <FeedEndLabel {...comparedChartProps} />}
          {comparedVersionProp && <FeedSpan {...comparedChartProps} isServiceGap={false} />}
