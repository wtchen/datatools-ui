...
export default class DeploymentConfirmModal extends MessageComponent<Props, State> {
  state = {}
...
class DeploymentConfirmModalAlert extends MessageComponent<DeploymentConfirmModalAlertProps> {
  render () {
