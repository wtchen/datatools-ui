    ...
    return (
      <Row>
        ...
        <Col xs={12} sm={8}>
          ...
          <Panel header={<h3>{this.generalSettingsMessages('flex.title')}</h3>}>
            <FormGroup>
              <Checkbox
                checked={model.flexUIFeaturesEnabled}
                onChange={this._toggleCheckBox('flexUIFeaturesEnabled')}>
                <strong>{this.generalSettingsMessages('flex.checkbox')}</strong>
              </Checkbox>
              <small >{this.generalSettingsMessages('flex.description')}</small>
            </FormGroup>
          </Panel>
