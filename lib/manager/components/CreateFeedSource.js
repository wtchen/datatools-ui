...
export default class CreateFeedSource extends Component<Props, State> {
  generalSettingsMessages = getComponentMessages('GeneralSettings')
    ...
    return (
      <Row>
        ...
        <Col xs={12} sm={8}>
              ...
              <ListGroupItem>
                <FormGroup>
                  ...
                  <small>
                    ...
                    (OTP) instance (defined in organization settings) as part of
                    a collection of feed sources or individually.
                  </small>
                </FormGroup>
              </ListGroupItem>
            </ListGroup>
          ...
          <Panel>
            <Panel.Heading>
              {this.generalSettingsMessages('flex.title')}
            </Panel.Heading>
            <ListGroup fill>
              <ListGroupItem>
                <FormGroup>
                  <Checkbox
                    checked={model.flexUIFeaturesEnabled}
                    onChange={this._toggleCheckBox('flexUIFeaturesEnabled')}
                  >
                    <strong>
                      {this.generalSettingsMessages('flex.checkbox')}
                    </strong>
                  </Checkbox>
                  <small>
                    {this.generalSettingsMessages('flex.description')}
                  </small>
                </FormGroup>
              </ListGroupItem>
            </ListGroup>
            ...
            <ListGroup fill>
              ...
              <ListGroupItem>
                <FormGroup>
                  ...
                  <small>
                    Set this feed source to fetch automatically. (Feed source
                    URL must be specified and project auto fetch must be
                    enabled.)
                  </small>
                  {model.autoFetchFeed ? (
                    <FeedFetchFrequency
              ...
              <ListGroup fill>
                <ListGroupItem>
                  <FormGroup>
                    ...
                    <small>
                      Set this feed source to be automatically published when a
                      new version is automatically fetched.
                    </small>
                  </FormGroup>
                </ListGroupItem>
              </ListGroup>
