  ...
  render () {
    ...
    return (
      <div>
        ...
        <Panel>
          <Panel.Heading>{this.messages('title')}</Panel.Heading>
          <ListGroup fill>
            <ListGroupItem>
              <FormGroup
        ...
        <Panel>
          <Panel.Heading>{this.messages('fields.updates.title')}</Panel.Heading>
          <ListGroup fill>
            <ListGroupItem>
              <FormGroup>
                <Checkbox
        ...
        <Panel >
          <Panel.Heading>{this.messages('fields.location.title')}</Panel.Heading>
          <ListGroup fill>
            <ListGroupItem>
              <FormGroup>
                <ControlLabel>
        ...
        <Panel>
          <Panel.Heding>Local Places Index</Panel.Heding>
          <ListGroup fill>
            <ListGroupItem>
