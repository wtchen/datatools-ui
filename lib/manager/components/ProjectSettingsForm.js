  ...
  render () {
    ...
    return (
      <div>
        ...
        <Panel>
          <Panel.Heading><Panel.Title componentClass='h3'>{this.messages('fields.updates.title')}</Panel.Title></Panel.Heading>
          <ListGroup fill>
            <ListGroupItem>
              <FormGroup>
                <Checkbox
        ...
        <Panel >
          <Panel.Heading><Panel.Title componentClass='h3'>{this.messages('fields.location.title')}</Panel.Title></Panel.Heading>
          <ListGroup fill>
            <ListGroupItem>
              <FormGroup>
                <ControlLabel>
        ...
        <Panel>
          <Panel.Heading><Panel.Title componentClass='h3'>Local Places Index</Panel.Title></Panel.Heading>
          <ListGroup fill>
            <ListGroupItem>
