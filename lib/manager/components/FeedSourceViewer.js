...
import type {ManagerUserState, RouteParams} from '../../types/reducers'
...
type Props = {
  ...
  feedSource: Feed,
  feedSourceId: string,
  feedSourcePropertyChanged: typeof feedsActions.updateFeedSource,
  ...
  confirmDeleteFeedSource = () => {
    ...
    this.refs.page.showConfirmModal({
      ...
      onConfirm: () => deleteFeedSource(feedSource)
        ...
        .then(
          () => browserHistory.push(`/project/${feedSource.projectId}`)
        )
    })
  }
