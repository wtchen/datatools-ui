...
export default class FeedSourceViewer extends Component {
  ...
  render () {
    ...
    // FIXME: Use isEditingDisabled
    // import {isEditingDisabled} from '../util'
    // || isEditingDisabled(user, feedSource, project)
    const editDisabled = isEditingDisabled(user, feedSource, project)
    //const editDisabled = disabled && !user.permissions.hasFeedPermission(project.organizationId, project.id, feedSourceId, 'edit-gtfs')
