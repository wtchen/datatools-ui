...
export default class GtfsValidationViewer extends Component<Props, State> {
  ...
  componentWillMount () {
    if (!this._errorCountFetched(this.props.validationResult)) {
  ...
  componentWillReceiveProps (nextProps: Props) {
    if (
      this._errorCountFetched(this.props.validationResult) &&
      !this._errorCountFetched(nextProps.validationResult)
    ) {
  ...
  _errorCountFetched = (result: ValidationResult): boolean => {
  ...
  render () {
    ...
    const hasValidation = this._errorCountFetched(result)
