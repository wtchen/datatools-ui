              ...
              <Row
                ...
                <Col xs={12}>
                  <h4>
                    ...
                    {' '}
                    {isBlockingIssue && <BsLabel bsStyle='danger'>BLOCKING</BsLabel>}
                    <span
                      className={`pull-right gtfs-error-${
                        category.priority
                          ? category.priority.toLowerCase()
                          : 'unknown'
                      }`}
                    >
                      <Icon
                        type={validationErrorIconLookup[category.priority]}
                      /> {category.count}
                    </span>
                  </h4>
                </Col>
