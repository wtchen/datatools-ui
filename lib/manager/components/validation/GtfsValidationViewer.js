...
import type {Feed, FeedVersion, Project, ValidationResult} from '../../../types'
import type {GtfsState, UserState} from '../../../types/reducers'
...
export default class GtfsValidationViewer extends Component<Props, State> {
  ...
  _validationHasErrors = (result: ValidationResult): boolean => {
