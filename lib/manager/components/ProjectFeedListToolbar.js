...
export default class ProjectFeedListToolbar extends Component {
  static propTypes = {
  ...
  _onNewFeedSourceClick = () => {
    browserHistory.push(`/project/${this.props.project.id}/newFeedSource`)
  }
        ...
        <Col xs={8}>
          {!projectEditDisabled &&
            <Button
              ...
              onClick={this._onNewFeedSourceClick}>
