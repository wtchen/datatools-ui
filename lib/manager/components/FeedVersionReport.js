      ...
      return <span>
        ...
        <Button
          ...
          onClick={() => {
            ...
            fileDownload(JSON.stringify(version.isochrones), `isochrones_${version.feedSource.name.replace(/[^a-zA-Z0-9]/g, '_')}.json`, 'text/json')
          }}>
      ...
      >
        <ListGroup fill>
          <ListGroupItem
            ...
            >
            <ButtonGroup bsSize='small' style={{position: 'absolute', zIndex: 2000, right: 5, top: 5}}>
