  ...
  render () {
    ...
    return (
      <Panel>
        <Row>
          <Col xs={12}>
            <h4 style={{marginTop: 0, marginBottom: 15}}>
              <Button className='pull-right' bsSize='small' onClick={() => logoutHandler()}><Icon type='sign-out' /> Log out</Button>
        ...
        <Row>
          <Col xs={4}>
            <img style={{ width: '100%', borderRadius: '50%' }} src={user.profile.picture} />
          </Col>
          <Col md={8}>
