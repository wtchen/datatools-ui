...
import type {Feed, FeedVersion, ValidationSummary} from '../../types'
import type {
...
export default class FeedSourceTableRow extends PureComponent<Props> {
  ...
  render () {
    ...
    const comparisonValidationSummary = comparisonVersion && (
      comparisonVersion.validationSummary || comparisonVersion.validationResult
    )
    ...
    if (comparisonData && comparisonVersion && comparisonValidationSummary) {
