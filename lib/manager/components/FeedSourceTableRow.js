...
//
/**
 * This method is extracted variable generation which had to be split out
 * of the render function to appease the eslint complexity rule
 */
          ...
          <Col xs={12}>
            <div className='feedSourceLabelRow'>
              ...
              <div className='feedLabelContainer'>
                {deStringifyLabels(feedSource.labels, project).map((label) => (
...
class FeedActionsDropdown extends PureComponent<Props> {
  ...
  /**
   * This method is extracted variable generation which had to be split
   * out of the render function to appease the eslint complexity rule
