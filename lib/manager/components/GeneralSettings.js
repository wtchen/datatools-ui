  ...
  render () {
    ...
    return (
      <Col xs={7}>
        ...
        <Panel header={<h3>{this.messages('flex.title')}</h3>}>
          <FormGroup>
            <Checkbox
            ...
            {feedSource.flex && <small style={{display: 'block', paddingTop: 5}}>Flex tools in the editor can not be disabled while flex features are used in the feed. <strong>To disable flex tools in the editor, remove all flex features from the feed. This checkbox will then be un-checkable.</strong></small>}
          </FormGroup>
        </Panel>
