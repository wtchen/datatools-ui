...
export default class GeneralSettings extends Component<Props, State> {
  ...
  _onSaveSettings = () => {
    this.props.updateProject(this.props.project.id || '', this.state.model)
  }
            ...
            <ListGroupItem>
              <FormGroup>
                <Checkbox
                  ...
                  <strong>
                    {getMessage(messages, 'fields.updates.autoFetchFeeds')}
                  </strong>
                </Checkbox>
                {autoFetchChecked
                  ? <DateTimeField
          ...
          <ListGroup fill>
            <ListGroupItem>
              ...
              >
                <ControlLabel>
                  ...
                  {getMessage(messages, 'fields.location.defaultLocation')}
                </ControlLabel>
            ...
            <ListGroupItem>
              <FormGroup>
                <ControlLabel>
                  ...
                  {getMessage(messages, 'fields.location.boundingBox')}
                </ControlLabel>
            ...
            <ListGroupItem>
              <ControlLabel>
                ...
                {getMessage(messages, 'fields.location.defaultTimeZone')}
              </ControlLabel>
              <TimezoneSelect
            ...
            <ListGroupItem>
              <ControlLabel>
                ...
                {getMessage(messages, 'fields.location.defaultLanguage')}
              </ControlLabel>
              <LanguageSelect
