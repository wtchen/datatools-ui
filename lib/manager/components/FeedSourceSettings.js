...
import {Glyphicon, Col, Row, Tab, ListGroup, ListGroupItem, Button, Panel, FormControl, InputGroup, ControlLabel, FormGroup, Checkbox} from 'react-bootstrap'
...
export default class FeedSourceSettings extends Component {
  ...
  _externalPropertyChanged = (name, value) => {
    const {externalPropertyChanged, feedSource, resourceType} = this.props
          ...
          {!resourceType
            ...
            : <Col xs={7}>
              <ExternalPropertiesTable
                ...
                externalPropertyChanged={this._externalPropertyChanged} />
            </Col>
          }
        </Row>
      </Tab>
