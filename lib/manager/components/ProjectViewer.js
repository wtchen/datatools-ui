...
export default class ProjectViewer extends MessageComponent<Props, State> {
  state = {}
...
class ProjectSummaryPanel extends MessageComponent<{feedSources: Array<Feed>, project: Project}> {
  render () {
