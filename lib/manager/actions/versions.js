...
const requestingFeedVersionIsochrones = createAction(
  'REQUESTING_FEEDVERSION_ISOCHRONES',
  (payload: {
    feedVersion: FeedVersion,
    fromLat: number,
    fromLon: number,
...
const requestingValidationIssueCount = createAction(
  'REQUESTING_VALIDATION_ISSUE_COUNT',
  (payload: any) => payload
)
...
export function fetchPublicFeedVersions (feedSource: Feed) {
  return function (dispatch: dispatchFn, getState: getStateFn) {
    dispatch(requestingFeedVersions(feedSource))
...
export function uploadFeed (feedSource: Feed, file: File) {
  return function (dispatch: dispatchFn, getState: getStateFn) {
    ...
    const lastModified: string = file.lastModifiedDate
...
export function fetchValidationIssueCount (feedVersion: FeedVersion) {
  return function (dispatch: dispatchFn, getState: getStateFn) {
