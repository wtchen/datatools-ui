...
// Deployment Actions
export const createDeployment = createAction('CREATE_DEPLOYMENT')
const requestingDeployments = createAction('REQUESTING_DEPLOYMENTS')
const receiveDeployments = createAction('RECEIVE_DEPLOYMENTS')
const deletingDeployment = createAction('DELETING_DEPLOYMENT')
const savingDeployment = createAction('SAVING_DEPLOYMENT')
const requestingDeployment = createAction('REQUESTING_DEPLOYMENT')
const receiveDeployment = createAction('RECEIVE_DEPLOYMENT')
const deployedToTarget = createAction('DEPLOYED_TO_TARGET')
...
export function fetchFeedSourceDeployments (feedSource) {
  return function (dispatch, getState) {
    dispatch(requestingDeployments())
