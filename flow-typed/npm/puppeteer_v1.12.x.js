// flow-typed signature: 04d5f047760c9b554dae8b941c933861
// flow-typed version: c6154227d1/puppeteer_v1.12.x/flow_>=v0.76.x <=v0.103.x
...
declare module 'puppeteer' {
   ...
   */
  declare export type WrapElementHandle<X> = $Call<
    (<T: Element>(T) => ElementHandle<T>) & (<T>(T) => T),
    X
  >;
   ...
   */
  declare export type UnwrapElementHandle<X> = $Call<
    <E>(value: ElementHandle<E> | E) => E,
    X
  >;
   ...
   */
  declare export interface Evalable {
    /**
   ...
   */
  declare export interface Keyboard {
    /**
  ...
  declare export interface Touchscreen {
    /**
   ...
   */
  declare export interface Dialog {
    /**
     * Accepts the dialog.
  ...
  declare export type ConsoleMessageType =
    | 'log'
    | 'debug'
    | 'info'
    | 'error'
   ...
   */
  declare export interface ConsoleMessage {
    /**
  ...
  declare export interface DeleteCookie {
    /**
     * The cookie name.
     */
    name: string;
  ...
  declare export interface SetCookie {
    /**
     * The cookie name.
     */
    name: string;
   ...
   */
  declare export type LayoutDimension = string | number;
  ...
  declare export interface BoxModel {
    /**
   ...
   */
  declare export interface ElementHandle<E: Element>
    extends JSHandle, Evalable {
    /**
   ...
   */
  declare export interface ExecutionContext {
    evaluate(fn: EvaluateFn, ...args: any[]): Promise<any>;
    evaluateHandle(fn: EvaluateFn, ...args: any[]): Promise<JSHandle>;
   ...
   */
  declare export interface JSHandle {
    /**
  ...
  declare export type ErrorCode =
    ...
    | 'timedout'
    | 'failed';
  declare export interface Overrides {
    url?: string;
    method?: HttpMethod;
    postData?: string;
    headers?: Headers;
...
*/
  ...
  declare export interface Frame extends FrameBase {
    childFrames(): Frame[];
   ...
   */
  declare export interface Accessibility {
  ...
  declare export interface Page extends OverridableEventEmitter, FrameBase {
     ...
     */
    on<K: $Keys<PageEventObj>>(
      eventName: K,
      handler: (e: $ElementType<PageEventObj, K>, ...args: any[]) => void
    ): Page;
     ...
     * @param args The arguments to pass to the `fn`.
     */
    evaluateOnNewDocument(fn: EvaluateFn, ...args: any[]): Promise<void>;
  ...
  declare export interface TargetAwaiter {
    waitForTarget(
  ...
  declare export interface Browser
    extends OverridableEventEmitter, TargetAwaiter {
    /**
     * Adds the listener function to the end of the listeners array for the event named `eventName`.
     * No checks are made to see if the listener has already been added. Multiple calls passing the same combination of
     * `eventName` and listener will result in the listener being added, and called, multiple times.
     ...
     * @param handler The callback function.
     */
    on<K: $Keys<BrowserEventObj>>(
      eventName: K,
      handler: (e: $ElementType<BrowserEventObj, K>, ...args: any[]) => void
    ): Browser;
   ...
   */
  declare export interface BrowserContext
    extends OverridableEventEmitter, TargetAwaiter {
    /**
     * Adds the listener function to the end of the listeners array for the event named `eventName`.
     * No checks are made to see if the listener has already been added. Multiple calls passing the same combination of
     ...
     * @param handler The callback function.
     */
    on<K: $Keys<BrowserContextEventObj>>(
      eventName: K,
      handler: (
        e: $ElementType<BrowserContextEventObj, K>,
        ...args: any[]
      ) => void
    ): BrowserContext;
     ...
     * @param handler The callback function.
     */
    once<K: $Keys<BrowserContextEventObj>>(
      eventName: K,
      handler: (
        e: $ElementType<BrowserContextEventObj, K>,
        ...args: any[]
  ...
  declare export type BrowserContextEventObj = {|
    /**
  ...
  declare export interface CDPSession extends OverridableEventEmitter {
    /**
   ...
   */
  declare export function connect(options?: ConnectOptions): Promise<Browser>;

  /**
   * The default flags that Chromium will be launched with
   */
  declare export function defaultArgs(options?: ChromeArgOptions): string[];

  /**
   * Path where Puppeteer expects to find bundled Chromium
   */
  declare export function executablePath(): string;

  /**
   * The method launches a browser instance with given arguments. The browser will be closed when the parent node.js process is closed.
   */
  declare export function launch(options?: LaunchOptions): Promise<Browser>;
}
