...
describe('end-to-end', () => {
  ...
  describe('editor', () => {
    ...
    describe('feed info', () => {
      ...
      }, 20000, 'should create feed info data')
    })
    ...
    describe('routes', () => {
      ...
      }, 20000, ['should create agency', 'should create route'])
    ...
    describe('timetables', () => {
      ...
      }, 20000, ['should create calendar', 'should create pattern'])
