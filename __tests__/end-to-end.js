...
const puppeteerOptions = {
  ...
  args: isCi || isDocker ? ['--no-sandbox', '--disable-setuid-sandbox', '--disable-gpu', '--unsafely-treat-insecure-origin-as-secure=http://datatools-ui:9966', '--allow-running-insecure-content', '--user-data-dir=/tmp/chromeuserdata'] : []
}
const testOptions = {
